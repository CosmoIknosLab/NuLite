...
from nuclei_detection.datasets.base_cell import CellDataset
...
class ExperimentNuLitePanNuke(BaseExperiment):
    ...
    def get_train_model(
        ...
        Args:
            ...
            backbone_type (str, optional): Backbone Type. Currently supported
        ...
        # check for backbones
        implemented_backbones = ["fastvit_sa36", 'fastvit_t8', "fastvit_sa24", "fastvit_sa12", "fastvit_s12",
                                 "fastvit_t12", "fastvit_ma36"]
        ...
        self.logger.info(f"Loaded NuLite model with backbone: {backbone_type}")
