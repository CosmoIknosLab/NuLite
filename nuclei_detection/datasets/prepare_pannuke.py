...
if __name__ == "__main__":
    ...
    #input_path = '/work/oldWork/default-ubuntu-rinaldi2-work-pvc-215307e1-04be-4abb-8a29-26eb803ad2b3/cristian/data/Pannuke'
    #output_path = '/work/cristian/data/prepared_pannuke'
    for fold in [0, 1, 2]:
